    ...
    public function index(Request $request)
    {
        $actividades = DB::table(DB::raw('actividades ac'))->where(DB::raw('ac.deleted_at', '=', NULL))
            ...
            ->select('ac.id', 'ac.titulo', 'ac.fecha', 'ac.descripcion', 'ac.estado',
                ...
                DB::raw('e.nombres as nombre_estudiante'), DB::raw('e.apellidos as apellido_estudiante'), DB::raw('e.telefono as telefono_estudiante'), DB::raw('e.correo as correo_estudiante'),
                ...
                DB::raw('tc.titulo as titulo_tipo_comportamiento'), DB::raw('tc.descripcion as descripcion_tipo_comportamiento'),
