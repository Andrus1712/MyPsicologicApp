            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <p class="help-block">Suba el archivol Excel.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label>Título Comportamiento: </label>
                        <div class="input-group">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea id="descripcion" class="form-control" style="resize: vertical;" rows="3" placeholder="Descripción..."></textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Título de la actividad" id="titulo">
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea id="descripcion" class="form-control" style="resize: vertical;" rows="3" placeholder="Escriba aquí la descripción de la actividad..."></textarea>
                    </div>
                </div>
            </div>
