...
@if (Auth()->user()->havePermission('show.comportamientos') || Auth()->user()->havePermission('tipos.comportamientos')
|| Auth()->user()->havePermission('show.actividades') || Auth()->user()->havePermission('show.avances')
|| Auth()->user()->havePermission('show.avances') || Auth()->user()->havePermission('modulo.seguimiento'))
