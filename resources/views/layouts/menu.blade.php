@if (Auth()
        ->user()
        ->havePermission('show.actividades'))
...
@if (Auth()
        ->user()
        ->havePermission('show.estudiantes') ||
    Auth()
        ->user()
        ->havePermission('show.docentes') ||
    Auth()
        ->user()
        ->havePermission('show.acudientes') ||
    Auth()
        ->user()
        ->havePermission('show.psicologos'))
...
@if (Auth()
        ->user()
        ->havePermission('show.comportamientos') ||
    Auth()
        ->user()
